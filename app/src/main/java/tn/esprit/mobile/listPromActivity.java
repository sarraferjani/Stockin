...
public class listPromActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listprom_activity);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(listPromActivity.this, AddPromotion.class);
                startActivity(intent);
            }
        });
        myDB= new MyDatabaseHelper(listPromActivity.this);
        id=new ArrayList<>();
        ...
        customAdapter=new CustomAdapter(listPromActivity.this,this,id,product_id,start_date,end_date,reduction);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(listPromActivity.this));
    }
